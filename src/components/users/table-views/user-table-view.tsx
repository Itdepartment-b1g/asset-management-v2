...
import { format_user_role } from "@/components/lib/user-roles";
      ...
      render: (row) => (
        <div className="flex items-center gap-2">
          {!row.role ? (
            <button
              type="button"
              className="inline-flex items-center gap-2 rounded-md border border-violet-200 bg-violet-50 px-2.5 py-1.5 text-xs font-medium text-violet-700 hover:bg-violet-100"
