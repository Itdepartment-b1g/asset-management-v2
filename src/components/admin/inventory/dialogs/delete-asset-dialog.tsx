...
import type { AssetListItem } from "../table-views/asset-table-view";
    ...
    >
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-base font-semibold text-zinc-900">Delete asset</h3>
          <button
            type="button"
            aria-label="Close"
        ...
        <p className="text-sm text-zinc-600">
          ...
          ({row.code_name})? Warranty and receipt photos will also be removed.
        </p>
