...
export const assetSchemas = {
  ...
  CreateAssetBody: {
    ...
    properties: {
      ...
      useful_life_end_date: { type: "string", format: "date" },
      original_issue_date: { type: "string", format: "date" },
      currently_issued_to_id: { type: "string", format: "uuid" },
      department_id: { type: "string", format: "uuid" },
      location_id: { type: "string", format: "uuid" },
      legend_id: { type: "string", format: "uuid" },
      warranty_photo: { type: "string", format: "binary" },
      receipt_photo: { type: "string", format: "binary" },
    },
    required: [
      "asset_name",
